            ...
            <div class="space-y-6">
                        ...
                        <div class="px-6 py-4 bg-gradient-to-r from-gray-50 to-white border-b border-gray-100 flex justify-between items-center">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-gray-500">{{ $category->menuItems->count() }} items</p>
                                </div>
                            </div>
                            <button type="button"
                        ...
                        <div class="p-6">
                            @if($category->menuItems->isEmpty())
                                <div class="text-center py-8">
                                    ...
                                    <a href="{{ route('pos.menu.items.create') }}" class="text-indigo-600 text-sm font-medium hover:text-indigo-700 mt-2 inline-block">Add first item</a>
                                </div>
                            @else
                                        ...
                                        <div class="flex gap-4 p-4 rounded-xl border {{ $item->is_available ? 'bg-white border-gray-200 hover:border-gray-300' : 'bg-red-50 border-red-200' }} transition-colors">
                                            ...
                                            <div class="flex-1 min-w-0">
                                                ...
                                                @if(!$item->is_available)
                                                    <span class="inline-block mt-2 px-2 py-0.5 bg-red-100 text-red-700 text-[10px] font-bold rounded-full uppercase">Unavailable</span>
                                                @endif
                ...
                @if($categories->isEmpty())
                    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-12 text-center">
                        ...
                        <h3 class="font-semibold text-gray-900 text-lg">No categories yet</h3>
                        <p class="text-gray-500 text-sm mt-1">Start by adding a category above, then add menu items.</p>
                    </div>
                @endif
            </div>
        </div>
                ...
                <div x-show="deleteModal"
                    ...
                    <div class="text-center">
                        ...
                        <h3 class="text-xl font-bold text-gray-900 mb-2">
                            Delete <span x-text="deleteType === 'category' ? 'Category' : 'Menu Item'"></span>
                        </h3>
                        <p class="text-gray-500 mb-1">Are you sure you want to delete <span class="font-semibold text-gray-700" x-text="deleteName"></span>?</p>
                        <p class="text-gray-400 text-sm mb-6" x-show="deleteType === 'category'">This will also delete all items in this category.</p>
                        <p class="text-gray-400 text-sm mb-6" x-show="deleteType === 'item'">This action cannot be undone.</p>
