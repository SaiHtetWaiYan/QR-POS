    ...
    <x-slot name="header">
        <div class="flex items-center gap-4">
            ...
            <div>
                ...
                <p class="text-sm text-gray-500">{{ __('Create a new table with QR code') }}</p>
            </div>
        </div>
    </x-slot>
        ...
        <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                <form action="{{ route('pos.tables.store') }}" method="POST" class="p-6 space-y-6">
                    ...
                    <div>
                        <label class="block font-medium text-sm text-gray-700 mb-1.5">{{ __('Table Name') }}</label>
                        <div class="relative">
                            ...
                            <input type="text"
                                   name="name"
                                   placeholder="{{ __('e.g. Table 1, Patio A') }}"
                    ...
                    <div>
                        <label class="block font-medium text-sm text-gray-700 mb-1.5">{{ __('Unique Code') }}</label>
                        <div class="relative">
                            <div class="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none">
                                <svg class="w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <input type="text"
                                   name="code"
                                   placeholder="{{ __('e.g. t1-patio, table-window') }}"
                        ...
                        <p class="text-xs text-gray-500 mt-1.5 flex items-center gap-1">
                            ...
                            {{ __('This will be part of the URL: /t/') }}<strong>{{ __('your-code') }}</strong>
                        </p>
                    </div>
